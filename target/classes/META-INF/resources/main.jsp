                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="#category-panel-body" class="panel-title" data-toggle="collapse"
                                   data-parent="#acc"><span class="glyphicon glyphicon-film"></span>&nbsp;类别管理</a>
                            </div>
                            ...
                            <div class="panel-collapse collapse" id="category-panel-body">
                                <div class="panel-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <a id="categroy-btn" href="javascript:$('#centerLayout').load('${path}/back/categroy.jsp')" class="btn btn-default yx-nav-menu-btn">  &nbsp;视频管理 </a>
                                        </li>
